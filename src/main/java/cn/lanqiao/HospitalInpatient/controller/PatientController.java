...
import cn.lanqiao.HospitalInpatient.dto.ParientDto;

import cn.lanqiao.HospitalInpatient.pojo.Patient;
...
public class PatientController {
    ...
    public Result<List<Patient>> select(ParientDto parientDto) {
